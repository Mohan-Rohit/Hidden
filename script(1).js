...
const translations = {
    ...
    en: {
        ...
        level1Rules: "40 hidden cards: 25 positive numbers and 15 negative numbers, with values from 1 to 100. Select a card and its value is added to your score if positive or subtracted if negative.",

        level2: "LEVEL 2",
        negativeZone: "MEMORY SHUFFLE",
        level2Rules: "Memory Shuffle: 5 cards show +100, -200, +300, -400 and +500 for 7 seconds. The values then hide and the cards swap places. Choose one card. 2 players get two chances each; 4 players get one chance each, always in registration order.",
        level2Preview: "Remember the five values...",
        level2Shuffling: "Numbers hidden! Watch the cards swap places...",
        ...
        rulesViewTwo: "2 Player Rules",
        rulesViewFour: "4 Player Rules",
        rulesTwoIntro: "The 2-player game has 4 levels. The game ends after Level 4.",

        rulesLevel1Title: "Level 1 — Lucky Start",
        rulesLevel1Text: "There are 40 hidden cards: 25 positive numbers and 15 negative numbers. Each value is from 1 to 100. Cards are placed randomly. A positive value is added to the current player's score and a negative value is subtracted.",

        rulesLevel2Title: "Level 2 — Memory Shuffle",
        rulesLevel2Text: "Five cards show +100, -200, +300, -400 and +500 for 7 seconds. The numbers are then hidden and the five cards swap places. Each player selects one card. In a 4-player game each player gets one chance; in a 2-player game each player gets two chances in registration order (A, B, A, B). The selected value is added to the player's score, including negative values.",
    ...
    te: {
        ...
        level1Rules: "40 దాగి ఉన్న కార్డులు: 25 పాజిటివ్ నంబర్లు మరియు 15 నెగెటివ్ నంబర్లు. ప్రతి విలువ 1 నుండి 100 వరకు ఉంటుంది. పాజిటివ్ విలువ స్కోర్‌కు జోడించబడుతుంది మరియు నెగెటివ్ విలువ స్కోర్ నుండి తగ్గించబడుతుంది.",

        level2: "లెవెల్ 2",
        negativeZone: "మెమరీ షఫుల్",
        level2Rules: "మెమరీ షఫుల్: +100, -200, +300, -400, +500 ఉన్న 5 కార్డులు 7 సెకన్లు కనిపిస్తాయి. తర్వాత నంబర్లు దాగి కార్డులు స్థానాలు మార్చుకుంటాయి. 2 ప్లేయర్లకు ఒక్కొక్కరికి 2 అవకాశాలు, 4 ప్లేయర్లకు ఒక్కొక్కరికి 1 అవకాశం. టర్న్స్ రిజిస్ట్రేషన్ ఆర్డర్‌లో ఉంటాయి.",
        level2Preview: "ఐదు విలువలను గుర్తుంచుకోండి...",
        level2Shuffling: "నంబర్లు దాగాయి! కార్డులు స్థానాలు మార్చుకోవడాన్ని గమనించండి...",
        ...
        rulesViewTwo: "2 ప్లేయర్ రూల్స్",
        rulesViewFour: "4 ప్లేయర్ రూల్స్",
        ...
        rulesLevel1Text: "40 దాగి ఉన్న కార్డులు ఉంటాయి: 25 పాజిటివ్ నంబర్లు మరియు 15 నెగెటివ్ నంబర్లు. ప్రతి విలువ 1 నుండి 100 వరకు ఉంటుంది. పాజిటివ్ విలువ స్కోర్‌కు జోడించబడుతుంది మరియు నెగెటివ్ విలువ స్కోర్ నుండి తగ్గించబడుతుంది.",

        rulesLevel2Title: "లెవెల్ 2 — మెమరీ షఫుల్",
        rulesLevel2Text: "+100, -200, +300, -400, +500 విలువలతో 5 కార్డులు 7 సెకన్లు కనిపిస్తాయి. తర్వాత నంబర్లు దాగి 5 కార్డులు స్థానాలు మార్చుకుంటాయి. 4 ప్లేయర్ల గేమ్‌లో ప్రతి ప్లేయర్‌కు 1 అవకాశం ఉంటుంది. 2 ప్లేయర్ల గేమ్‌లో ప్రతి ప్లేయర్‌కు 2 అవకాశాలు ఉంటాయి: A, B, A, B. టర్న్స్ రిజిస్ట్రేషన్ ఆర్డర్‌లో ఉంటాయి. ఎంచుకున్న విలువ స్కోర్‌కు జోడించబడుతుంది; నెగెటివ్ విలువ స్కోర్‌ను తగ్గిస్తుంది.",
    ...
    hi: {
        ...
        level1Rules: "40 छिपे हुए कार्ड: 25 पॉजिटिव नंबर और 15 नेगेटिव नंबर। हर मूल्य 1 से 100 तक है। पॉजिटिव मूल्य स्कोर में जुड़ता है और नेगेटिव मूल्य स्कोर से घटता है।",

        level2: "लेवल 2",
        negativeZone: "मेमोरी शफल",
        level2Rules: "मेमोरी शफल: +100, -200, +300, -400 और +500 वाले 5 कार्ड 7 सेकंड तक दिखेंगे। फिर नंबर छिप जाएंगे और कार्ड अपनी जगह बदलेंगे। 4 खिलाड़ियों में हर खिलाड़ी को 1 मौका और 2 खिलाड़ियों में हर खिलाड़ी को 2 मौके मिलेंगे: A, B, A, B. टर्न रजिस्ट्रेशन ऑर्डर में होंगे।",
        level2Preview: "पाँचों मूल्यों को याद रखें...",
        level2Shuffling: "नंबर छिप गए! कार्डों को जगह बदलते देखें...",
        ...
        rulesViewTwo: "2 खिलाड़ियों के नियम",
        rulesViewFour: "4 खिलाड़ियों के नियम",
        ...
        rulesLevel1Text: "40 छिपे हुए कार्ड होते हैं: 25 पॉजिटिव नंबर और 15 नेगेटिव नंबर। हर मूल्य 1 से 100 तक होता है। पॉजिटिव मूल्य स्कोर में जुड़ता है और नेगेटिव मूल्य स्कोर से घटता है।",

        rulesLevel2Title: "लेवल 2 — मेमोरी शफल",
        rulesLevel2Text: "5 कार्ड +100, -200, +300, -400 और +500 दिखाएंगे। वे 7 सेकंड बाद छिप जाएंगे और कार्ड अपनी जगह बदलेंगे। 4 खिलाड़ियों में हर खिलाड़ी को 1 मौका और 2 खिलाड़ियों में हर खिलाड़ी को 2 मौके मिलेंगे: A, B, A, B. टर्न रजिस्ट्रेशन ऑर्डर में होंगे। चुना गया मूल्य खिलाड़ी के स्कोर में जुड़ता है, जिसमें नेगेटिव मूल्य स्कोर घटाता है।",
...
const rulesTwoPlayerBtn =
    document.getElementById("rulesTwoPlayerBtn");

const rulesFourPlayerBtn =
    document.getElementById("rulesFourPlayerBtn");
...
let level2Previewing = false;

let level2Shuffling = false;

let level2ShuffleCount = 0;

let level2RoundNumber = 0;

const level2TotalRounds = 4;
...
function createLevel2() {
    ...
    currentPlayerIndex = 0;
    level2RoundNumber = 0;
    level2Previewing = false;
    level2Shuffling = false;
    level2ShuffleCount = 0;
    selectedCards = 0;
...
function createLevel2Round() {

    level2Previewing = true;
    level2Shuffling = false;
    level2ShuffleCount = 0;
    selectedCards = 0;

    cards = [
        { value: 100, type: "number", shuffleId: "l2-1", colorIndex: 0, revealed: false },
        { value: -200, type: "number", shuffleId: "l2-2", colorIndex: 1, revealed: false },
        { value: 300, type: "number", shuffleId: "l2-3", colorIndex: 2, revealed: false },
        { value: -400, type: "number", shuffleId: "l2-4", colorIndex: 3, revealed: false },
        { value: 500, type: "number", shuffleId: "l2-5", colorIndex: 4, revealed: false }
    ];

    renderCards();
    updateLevelUI();
    updateTurnDisplay();
    updateGameMessage(t("level2Preview"));
    ...
    addTimer(previewTimer);

}


function startLevel2Shuffle() {

    level2Shuffling = true;
    level2ShuffleCount = 0;
    updateGameMessage(t("level2Shuffling"));
    performLevel2Swap();

}


function performLevel2Swap() {

    if (!level2Shuffling || currentLevel !== 2) {
        return;
    }
    ...
    let first = randomInt(0, cards.length - 1);
    let second = randomInt(0, cards.length - 1);

    while (second === first) {
        second = randomInt(0, cards.length - 1);
    }
    ...
    buttonsAfter.forEach(button => {
        ...
        const oldRect =
            positions.get(button.dataset.cardId);
        ...
        requestAnimationFrame(() => {
            button.style.transition = "transform 0.45s ease";
    ...
    const finishTimer = setTimeout(() => {
        ...
        level2Shuffling = false;
        renderCards();
        updateGameMessage(t("selectCard"));

    }, 550);

    addTimer(finishTimer);
...
function renderCards() {
    ...
    cards.forEach(
        (card, index) => {
            ...
            if (currentLevel === 1 && card.type === "number") {
                button.classList.add(
                    card.value < 0 ? "negative-card" : "positive-card"
                );
            }
            ...
            if (card.shuffleId) {
                button.dataset.cardId = card.shuffleId;
            }
            ...
            if (
                card.revealed ||
                (currentLevel === 2 && level2Previewing)
            ) {
                ...
                /* Level 2 is guarded inside selectLevel2Card().
                   Keep the button enabled so it responds as soon as the
                   shuffle is complete. */
...
function selectLevel2Card(index) {
    ...
    if (!card || card.revealed || !player || player.eliminated) {
        return;
    }
    ...
    updateGameMessage(
        `${player.name}: ${sign}${card.value} ${t("points")}`
    );

    level2RoundNumber++;

    if (level2RoundNumber >= level2TotalRounds) {
...
function selectCard(index) {
    ...
    if (
        ...
        message =
            `${player.name}: ${card.value >= 0 ? "+" : ""}${card.value} ${t("points")}`;
...
function announceValue(card) {
    ...
    /*
       Sound is played for card selections and special cards.
    */
    ...
    if (
        ...
        if (
            ...
            text =
                card.value >= 0
                    ? `పాజిటివ్ ${card.value} పాయింట్లు`
                    : `మైనస్ ${Math.abs(card.value)} పాయింట్లు`;
            ...
            text =
                card.value >= 0
                    ? `पॉजिटिव ${card.value} पॉइंट्स`
                    : `माइनस ${Math.abs(card.value)} पॉइंट्स`;
            ...
            text =
                card.value >= 0
                    ? `positive ${card.value} points`
                    : `negative ${Math.abs(card.value)} points`;
...
function openRules(mode = null) {

    if (mode === "game") {
        rulesViewPlayerCount = playerCount;
    }
...
function updateRulesModeButtons() {

    if (!rulesTwoPlayerBtn || !rulesFourPlayerBtn) {
        return;
    }

    rulesTwoPlayerBtn.classList.toggle(
        "active",
        rulesViewPlayerCount === 2
    );

    rulesFourPlayerBtn.classList.toggle(
        "active",
        rulesViewPlayerCount === 4
    );

}


rulesTwoPlayerBtn.addEventListener(
    "click",
    function () {
        rulesViewPlayerCount = 2;
        updateRulesModeButtons();
...
rulesFourPlayerBtn.addEventListener(
    "click",
    function () {
        rulesViewPlayerCount = 4;
        updateRulesModeButtons();
